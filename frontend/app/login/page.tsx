          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Stack spacing={2.5}>
              ...
              <Typography variant="h2">
                Portal login for company representatives and CDC workflows
              </Typography>
              <Typography color="text.secondary">
                Sign in to continue your company registration, access saved
                JNFs, and coordinate placement activity through one portal.
              </Typography>
              <Box
                sx={{
                  p: 3,
