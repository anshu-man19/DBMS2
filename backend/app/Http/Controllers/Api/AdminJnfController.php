...
class AdminJnfController extends Controller
{
    ...
    public function approve(Request $request, Jnf $jnf): JsonResponse
    {
        ...
        $this->afterAdminDecision($request, $jnf, 'jnf', $fromStatus, 'accepted', 'Your JNF has been accepted.');
    ...
    public function approveInf(Request $request, Inf $inf): JsonResponse
    {
        ...
        $inf->update(['status' => 'accepted']);
        $this->afterAdminDecision($request, $inf, 'inf', $fromStatus, 'accepted', 'Your INF has been accepted.');
