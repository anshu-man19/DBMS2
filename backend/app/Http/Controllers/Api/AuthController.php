...
class AuthController extends Controller
{
    ...
    public function registerAdmin(Request $request): JsonResponse
    {
        ...
        $expectedSecret = (string) config('app.admin_register_secret', env('ADMIN_REGISTER_SECRET', ''));
        abort_if($expectedSecret === '' || ! hash_equals($expectedSecret, $validated['admin_secret']), 403, 'Invalid admin registration secret.');
